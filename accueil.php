...
<head>
    ...
    <style>
        ...
        body {
            ...
            color: #000;
            /* Décale tout le contenu pour ne pas qu'il glisse sous l'en-tête fixe commune */
        ...
        /* Appel à l'action / Digitalisation */
        .digital-callout {
            font-weight: bold;
            max-width: 700px;
            margin: 40px auto;
        ...
        /* Blocs argumentaires (Pourquoi aidez nos PME...) */
        .argument-block {
            max-width: 650px;
            margin: 40px auto;
            font-size: 1.15rem;
        ...
        /* ==========================================================================
           AJUSTEMENTS RESPONSIVES POUR ECRANS MOBILES (Max 767px)
           ========================================================================== */
        @media (max-width: 767px) {
            body {
                padding-top: 80px !important; /* Ajustement de l'espace haut sur mobile */
            }
            ...
            .intro-text, .objectifs-list, .digital-callout, .argument-block {
                font-size: 1rem;
                padding-left: 10px;
                padding-right: 10px;
            }
            ...
            .carousel-item img {
                height: 220px; /* Évite de surcharger l'écran verticalement sur mobile */
            }
        }
    </style>
</head>
